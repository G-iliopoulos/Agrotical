...
export const users: User[] = [
  ...
  {
    id: 'farmer1',
    name: 'Γιώργης Κωστόπουλος',
    email: 'farmer1@agrotical.gr',
    password: 'farmer123',
    role: 'farmer',
    phone: '6981234567',
    location: 'Λάρισα',
    joinDate: '2023-03-10',
    active: true,
    assignedAgronomist: 'agro1',
  },
  {
    id: 'farmer2',
    name: 'Μαρία Αλεξίου',
    email: 'farmer2@agrotical.gr',
    password: 'farmer123',
    role: 'farmer',
    phone: '6991234567',
  ...
  {
    id: 'farmer3',
    name: 'Θανάσης Νικολάου',
    email: 'farmer3@agrotical.gr',
    password: 'farmer123',
    role: 'farmer',
    phone: '6951234567',
    location: 'Κρήτη',
    joinDate: '2023-05-05',
    active: true,
    assignedAgronomist: 'agro2',
  },
  {
    id: 'farmer4',
    name: 'Ελένη Δημητρίου',
    email: 'farmer4@agrotical.gr',
    password: 'farmer123',
    role: 'farmer',
    phone: '6961234567',
    location: 'Πάτρα',
  ...
  {
    id: 'agro1',
    name: 'Δρ. Αντώνης Λυκούργος',
    email: 'agro1@agrotical.gr',
    password: 'agro123',
    role: 'agronomist',
    phone: '6971112233',
    location: 'Λάρισα',
    joinDate: '2023-02-01',
    active: true,
    assignedFarmers: ['farmer1', 'farmer2'],
  },
  {
    id: 'agro2',
    name: 'Σοφία Παπακωνσταντίνου',
    email: 'agro2@agrotical.gr',
    password: 'agro123',
    role: 'agronomist',
    phone: '6972223344',
    location: 'Ηράκλειο',
    joinDate: '2023-02-15',
    active: true,
    assignedFarmers: ['farmer3', 'farmer4'],
  },
];
...
export const fields: Field[] = [
  {
    ...
    status: 'active',
    healthScore: 87,
    location: 'Λάρισα, Περιοχή Α',
    notes: 'Αρδεύεται κάθε 10 μέρες. Έγινε λίπανση τον Φεβρουάριο.',
    irrigationType: 'Σταγόνα',
    soilType: 'Αμμοπηλώδες',
    lastInspection: '2026-03-10',
    imageUrl: 'https://images.unsplash.com/photo-1627842822558-c1f15aef9838?w=600',
  },
  {
    id: 'field2',
    farmerId: 'farmer1',
    ...
    status: 'preparing',
    healthScore: 72,
    location: 'Λάρισα, Περιοχή Β',
    notes: 'Προετοιμασία εδάφους σε εξέλιξη.',
    irrigationType: 'Τεχνητή βροχή',
    soilType: 'Πηλώδες',
  ...
  },
  {
    ...
    status: 'harvested',
    healthScore: 91,
    location: 'Λάρισα, Περιοχή Γ',
    notes: 'Παλαιός ελαιώνας ~40 ετών. Εξαιρετική ποιότητα.',
    irrigationType: 'Σταγόνα',
    soilType: 'Ασβεστολιθικό',
    lastInspection: '2026-02-20',
    imageUrl: 'https://images.unsplash.com/photo-1722228097356-bd0202d99367?w=600',
  },
  {
    id: 'field4',
    farmerId: 'farmer1',
    ...
    status: 'harvested',
    healthScore: 78,
    location: 'Λάρισα, Περιοχή Δ',
    notes: 'Ποικιλία Ξινόμαυρο για τοπικό κρασί.',
    irrigationType: 'Σταγόνα',
    soilType: 'Πηλοαμμώδες',
    lastInspection: '2026-01-15',
    imageUrl: 'https://images.unsplash.com/photo-1504279577054-acfeccf8fc52?w=600',
  },
  {
    id: 'field5',
    farmerId: 'farmer2',
    ...
    status: 'preparing',
    healthScore: 85,
    location: 'Θεσσαλονίκη, Τοποθεσία Α',
    notes: 'Ετοιμασία για νέα σεζόν βαμβακιού.',
    irrigationType: 'Τεχνητή βροχή',
    soilType: 'Αργιλώδες',
  ...
  },
  {
    ...
    status: 'active',
    healthScore: 93,
    location: 'Θεσσαλονίκη, Τοποθεσία Β',
    notes: 'Βιομηχανική τομάτα. Σύμβαση με μεταποιητική εταιρεία.',
    irrigationType: 'Σταγόνα',
    soilType: 'Αμμοπηλώδες',
  ...
  },
  {
    ...
    status: 'active',
    healthScore: 88,
    location: 'Κρήτη, Τοποθεσία Α',
    notes: 'Ποικιλία Κορωνέικη. Εξαγωγή σε λάδι premium ποιότητας.',
    irrigationType: 'Σταγόνα',
    soilType: 'Ασβεστολιθικό',
  ...
  },
  {
    ...
    cropTypeId: 'wheat',
    careLevel: 'medium',
    plantingDate: '2025-11-25',
    expectedHarvestDate: '2026-06-20',
    status: 'active',
    healthScore: 75,
    location: 'Κρήτη, Τοποθεσία Β',
    notes: 'Χειμωνιάτικο σιτάρι σκληρό.',
    irrigationType: 'Βροχή',
    soilType: 'Πηλοαμμώδες',
...
export const tasks: Task[] = [
  {
    ...
    fieldId: 'field1',
    farmerId: 'farmer1',
    title: 'Άρδευση χωραφιού',
    description: 'Ποτίστε το χωράφι Νταμάρι για 3 ώρες',
    dueDate: '2026-03-25',
    completed: false,
    type: 'watering',
    priority: 'high',
  ...
  },
  {
    ...
    fieldId: 'field1',
    farmerId: 'farmer1',
    title: 'Λίπανση σιταριού',
    description: 'Εφαρμογή αζωτούχων λιπασμάτων (100kg/στρ)',
    dueDate: '2026-03-28',
    completed: false,
    type: 'fertilizing',
    priority: 'high',
  ...
  },
  {
    ...
    description: 'Οργωμα και ισοπέδωση για καλαμπόκι',
    dueDate: '2026-04-01',
    completed: false,
    type: 'plowing',
    priority: 'medium',
  ...
  },
  {
    ...
    fieldId: 'field1',
    farmerId: 'farmer1',
    title: 'Εφαρμογή ζιζανιοκτόνου',
    description: 'Καταπολέμηση αγριάδας και άλλων ζιζανίων',
    dueDate: '2026-04-05',
    completed: true,
    type: 'pesticide',
    priority: 'medium',
  ...
  },
  {
    ...
    fieldId: 'field3',
    farmerId: 'farmer1',
    title: 'Κλάδεμα ελαιών',
    description: 'Διαμορφωτικό κλάδεμα για καλύτερη παραγωγή',
    dueDate: '2026-04-10',
    completed: false,
    type: 'pruning',
    priority: 'low',
  ...
  },
  {
    ...
    fieldId: 'field5',
    farmerId: 'farmer2',
    title: 'Σπορά βαμβακιού',
    description: 'Έναρξη σποράς βαμβακιού στο Ξηρολάκκι',
    dueDate: '2026-04-20',
    completed: false,
    type: 'plowing',
    priority: 'high',
  ...
  },
  {
    ...
    fieldId: 'field6',
    farmerId: 'farmer2',
    title: 'Εμβολιασμός τομάτας',
    description: 'Εφαρμογή εντομοκτόνου για προστασία από έντομα',
    dueDate: '2026-03-26',
    completed: false,
    type: 'pesticide',
...
export const recommendations: Recommendation[] = [
  {
    ...
    farmerId: 'farmer1',
    fieldId: 'field1',
    title: 'Επιπλέον αζωτούχα λίπανση',
    content: 'Βάσει της ανάλυσης εδάφους που πραγματοποιήσαμε, συνιστώ επιπλέον εφαρμογή 50kg/στρ αζωτούχου λιπάσματος (26-0-0) στο σιτάρι του Νταμαριού. Η περίοδος εφαρμογής είναι τέλη Μαρτίου για βέλτιστα αποτελέσματα.',
    date: '2026-03-18',
    status: 'pending',
    priority: 'high',
    type: 'fertilizer',
  },
  {
    ...
    farmerId: 'farmer1',
    fieldId: 'field2',
    title: 'Επιλογή υβριδίου καλαμποκιού',
    content: 'Για τις συνθήκες του αγρού Κουτσούφλι, προτείνω χρήση υβριδίου Pioneer P9074 ή DKC6677, τα οποία έχουν αποδώσει καλά σε παρόμοια πηλώδη εδάφη της περιοχής.',
    date: '2026-03-15',
    status: 'read',
    priority: 'medium',
    type: 'general',
  },
  {
    ...
    farmerId: 'farmer2',
    fieldId: 'field5',
    title: 'Προσοχή σε αφίδες βαμβακιού',
    content: 'Έχουν αναφερθεί περιστατικά αφίδων σε παρακείμενα χωράφια. Προτείνω προληπτική εφαρμογή εντομοκτόνου (Imidacloprid ή Thiamethoxam) κατά τη σπορά.',
    date: '2026-03-20',
    status: 'pending',
    priority: 'urgent',
    type: 'pesticide',
  },
  {
    ...
    farmerId: 'farmer2',
    fieldId: 'field6',
    title: 'Βελτιστοποίηση άρδευσης τομάτας',
    content: 'Το σύστημα σταγόνας λειτουργεί καλά, αλλά προτείνω αύξηση της συχνότητας σε καθημερινή άρδευση κατά τη φάση ανθοφορίας για καλύτερη καρπόδεση.',
    date: '2026-03-12',
    status: 'applied',
    priority: 'medium',
    type: 'irrigation',
...
export const systemNotifications: SystemNotification[] = [
  {
    id: 'notif1',
    title: 'Νέα σύσταση γεωπόνου',
    message: 'Ο γεωπόνος σας έστειλε νέα σύσταση για το χωράφι Νταμάρι',
    date: '2026-03-18',
    read: false,
    type: 'info',
  },
  {
    id: 'notif2',
    title: 'Προειδοποίηση: Ξηρασία',
    message: 'Αναμένεται περίοδος ξηρασίας 7 ημερών. Ενισχύστε την άρδευση.',
    date: '2026-03-17',
    read: false,
    type: 'warning',
  },
  {
    id: 'notif3',
    title: 'Θυμηθείτε: Λίπανση σιταριού',
    message: 'Η λίπανση στο χωράφι Νταμάρι πλησιάζει στην προγραμματισμένη ημερομηνία',
    date: '2026-03-16',
    read: true,
    type: 'info',
  },
...
export const careLevelMultiplier: Record<CareLevel, number> = {
  low: 0.7,
  medium: 1.0,
  high: 1.3,
};

export const careLevelCostMultiplier: Record<CareLevel, number> = {
  low: 0.65,
  medium: 1.0,
  high: 1.38,
};
