...
export const fields: Field[] = [
  { id: 'field1', farmerId: 'farmer1', name: 'Χωράφι 1',    acres: 15, cropTypeId: 'wheat',    careLevel: 'high',   plantingDate: '2025-11-10', expectedHarvestDate: '2026-06-15', status: 'active',    healthScore: 87, location: 'Λάρισα, Περιοχή Α',        notes: 'Αρδεύεται κάθε 10 μέρες.',             irrigationType: 'Σταγόνα',        soilType: 'Αμμοπηλώδες',    lastInspection: '2026-03-10', imageUrl: 'https://images.unsplash.com/photo-1627842822558-c1f15aef9838?w=600' },
  { id: 'field2', farmerId: 'farmer1', name: 'Χωράφι 2',    acres:  8, cropTypeId: 'corn',     careLevel: 'medium', plantingDate: '2026-04-15', expectedHarvestDate: '2026-09-10', status: 'preparing', healthScore: 72, location: 'Λάρισα, Περιοχή Β',        notes: 'Προετοιμασία εδάφους.',                irrigationType: 'Τεχνητή βροχή', soilType: 'Πηλώδες',        lastInspection: '2026-03-05', imageUrl: 'https://images.unsplash.com/photo-1625246333195-78d9c38ad449?w=600' },
  { id: 'field3', farmerId: 'farmer1', name: 'Ελαιώνας 1',  acres: 12, cropTypeId: 'olives',   careLevel: 'low',    plantingDate: '2025-03-20', expectedHarvestDate: '2025-11-20', status: 'harvested', healthScore: 91, location: 'Λάρισα, Περιοχή Γ',        notes: 'Παλαιός ελαιώνας ~40 ετών.',           irrigationType: 'Σταγόνα',        soilType: 'Ασβεστολιθικό',  lastInspection: '2026-02-20', imageUrl: 'https://images.unsplash.com/photo-1722228097356-bd0202d99367?w=600' },
  { id: 'field4', farmerId: 'farmer1', name: 'Αμπελώνας 1', acres:  5, cropTypeId: 'grapes',   careLevel: 'high',   plantingDate: '2025-04-01', expectedHarvestDate: '2025-09-15', status: 'harvested', healthScore: 78, location: 'Λάρισα, Περιοχή Δ',        notes: 'Ποικιλία Ξινόμαυρο.',                  irrigationType: 'Σταγόνα',        soilType: 'Πηλοαμμώδες',    lastInspection: '2026-01-15', imageUrl: 'https://images.unsplash.com/photo-1504279577054-acfeccf8fc52?w=600' },
  ...
  { id: 'field6', farmerId: 'farmer2', name: 'Χωράφι 4',    acres:  6, cropTypeId: 'tomatoes', careLevel: 'high',   plantingDate: '2026-05-01', expectedHarvestDate: '2026-08-30', status: 'active',    healthScore: 93, location: 'Θεσσαλονίκη, Τοποθεσία Β', notes: 'Βιομηχανική τομάτα.',                  irrigationType: 'Σταγόνα',        soilType: 'Αμμοπηλώδες',    lastInspection: '2026-03-12' },
  { id: 'field7', farmerId: 'farmer3', name: 'Ελαιώνας 2',  acres: 25, cropTypeId: 'olives',   careLevel: 'medium', plantingDate: '2025-03-15', expectedHarvestDate: '2025-12-01', status: 'active',    healthScore: 88, location: 'Κρήτη, Τοποθεσία Α',       notes: 'Ποικιλία Κορωνέικη.',                  irrigationType: 'Σταγόνα',        soilType: 'Ασβεστολιθικό',  lastInspection: '2026-03-08' },
...
export const tasks: Task[] = [
  { id: 'task1', fieldId: 'field1', farmerId: 'farmer1', title: 'Άρδευση χωραφιού',       description: 'Ποτίστε το χωράφι για 3 ώρες',                    dueDate: '2026-03-25', completed: false, type: 'watering',     priority: 'high',   estimatedCost: 15  },
  ...
  { id: 'task3', fieldId: 'field2', farmerId: 'farmer1', title: 'Προετοιμασία εδάφους',   description: 'Όργωμα και ισοπέδωση για καλαμπόκι',               dueDate: '2026-04-01', completed: false, type: 'plowing',      priority: 'medium', estimatedCost: 120 },
  { id: 'task4', fieldId: 'field1', farmerId: 'farmer1', title: 'Εφαρμογή ζιζανιοκτόνου', description: 'Καταπολέμηση αγριάδας',                           dueDate: '2026-04-05', completed: true,  type: 'pesticide',    priority: 'medium', estimatedCost: 75  },
  ...
  { id: 'task6', fieldId: 'field5', farmerId: 'farmer2', title: 'Σπορά βαμβακιού',        description: 'Έναρξη σποράς βαμβακιού',                          dueDate: '2026-04-20', completed: false, type: 'plowing',      priority: 'high',   estimatedCost: 350 },
  { id: 'task7', fieldId: 'field6', farmerId: 'farmer2', title: 'Εμβολιασμός τομάτας',    description: 'Εφαρμογή εντομοκτόνου για προστασία από έντομα',    dueDate: '2026-03-26', completed: false, type: 'pesticide',    priority: 'high',   estimatedCost: 95  },
];

// ─── Recommendations ──────────────────────────────────────────────────────────

export const recommendations: Recommendation[] = [
  { id: 'rec1', agronomistId: 'agro1', farmerId: 'farmer1', fieldId: 'field1', title: 'Επιπλέον αζωτούχα λίπανση',       content: 'Βάσει ανάλυσης εδάφους, συνιστώ εφαρμογή 50kg/στρ αζωτούχου λιπάσματος (26-0-0) στο σιτάρι.', date: '2026-03-18', status: 'pending',   priority: 'high',   type: 'fertilizer' },
  { id: 'rec2', agronomistId: 'agro1', farmerId: 'farmer1', fieldId: 'field2', title: 'Επιλογή υβριδίου καλαμποκιού',    content: 'Προτείνω χρήση υβριδίου Pioneer P9074 ή DKC6677 για τις συνθήκες του αγρού.',                 date: '2026-03-15', status: 'read',      priority: 'medium', type: 'general'    },
  { id: 'rec3', agronomistId: 'agro1', farmerId: 'farmer2', fieldId: 'field5', title: 'Προσοχή σε αφίδες βαμβακιού',     content: 'Έχουν αναφερθεί περιστατικά αφίδων. Προτείνω προληπτική εφαρμογή εντομοκτόνου.',              date: '2026-03-20', status: 'pending',   priority: 'urgent', type: 'pesticide'  },
  { id: 'rec4', agronomistId: 'agro1', farmerId: 'farmer2', fieldId: 'field6', title: 'Βελτιστοποίηση άρδευσης τομάτας', content: 'Αύξηση συχνότητας σε καθημερινή άρδευση κατά τη φάση ανθοφορίας.',                           date: '2026-03-12', status: 'applied',   priority: 'medium', type: 'irrigation' },
];
...
export const systemNotifications: SystemNotification[] = [
  ...
  { id: 'notif3', title: 'Θυμηθείτε: Λίπανση',    message: 'Η λίπανση στο χωράφι Νταμάρι πλησιάζει στην προγραμματισμένη ημερομηνία', date: '2026-03-16', read: true,  type: 'info' },
];
...
export const soilYieldMultiplier: Record<string, number> = {
  'Πηλώδες': 1.15, 'Αμμοπηλώδες': 1.05, 'Πηλοαμμώδες': 1.00, 'Αργιλώδες': 0.90, 'Ασβεστολιθικό': 0.85,
};
export const soilCostMultiplier: Record<string, number> = {
  'Πηλώδες': 1.00, 'Αμμοπηλώδες': 0.95, 'Πηλοαμμώδες': 1.00, 'Αργιλώδες': 1.10, 'Ασβεστολιθικό': 1.18,
};
export const irrigationYieldMultiplier: Record<string, number> = {
  'Σταγόνα': 1.15, 'Τεχνητή βροχή': 1.05, 'Βροχή': 0.85, 'Υπόγεια': 1.20, 'Χωρίς άρδευση': 0.65,
};
export const irrigationCostMultiplier: Record<string, number> = {
  'Σταγόνα': 1.12, 'Τεχνητή βροχή': 1.07, 'Βροχή': 0.80, 'Υπόγεια': 1.20, 'Χωρίς άρδευση': 0.72,
};
...
export function calculateFieldFinancials(field: Field) {
  ...
  return {
    ...
    soilFactor:       Math.round(soilYield * 100),
    irrigationFactor: Math.round(irrigYield * 100),
  };
}

export function getFieldsByFarmer(farmerId: string) {
...
export function getFarmerTotals(farmerId: string) {
  ...
  return {
    totalAcres, totalRevenue, totalCosts, totalProfit, totalYield,
