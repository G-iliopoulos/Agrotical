...
const demoAccounts = [
  {
    ...
    password: 'admin123',
    icon: '⚙️',
    desc: 'Πλήρης διαχείριση συστήματος',
    color: '#7c3aed',
    bg: '#ede9fe',
    border: '#c4b5fd',
  },
  {
    ...
    password: 'farmer123',
    icon: '👨‍🌾',
    desc: 'Διαχείριση χωραφιών & εκτιμήσεις',
    color: '#2d6a4f',
    bg: '#d1fae5',
    border: '#6ee7b7',
  },
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 bg-gray-50">
        <div className="w-full max-w-md">
            ...
            <div className="mb-6" ref={dropdownRef}>
              <div className="relative">
                <button
                  ...
                  style={{
                    borderColor: showRoles ? '#40916c' : '#d1d5db',
                    color: showRoles ? '#2d6a4f' : '#6b7280',
                    fontWeight: 500,
                  }}
                >
                  ...
                  <ChevronDown
                    ...
                    style={{ transform: showRoles ? 'rotate(180deg)' : 'rotate(0deg)' }}
                  />
                </button>
                    ...
                    <div className="p-2 space-y-1">
                      {demoAccounts.map(acc => (
                        ...
                        >
                          ...
                          >
                            <span className="text-xs" style={{ color: acc.color }}>→</span>
                          </div>
                        </button>
                      ))}
                    </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="name@agrotical.gr"
                  className="w-full px-4 py-2.5 rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:border-green-400 text-sm transition-colors"
                  required
                />
              </div>
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <button type="button" className="text-xs" style={{ color: '#40916c', fontWeight: 500 }}>
                    Ξεχάσατε τον κωδικό;
                  </button>
                </div>
                <div className="relative">
                  <input
                    ...
                    placeholder="••••••••"
                    className="w-full px-4 py-2.5 rounded-xl border border-gray-200 bg-gray-50 focus:outline-none focus:border-green-400 text-sm transition-colors pr-10"
                    required
                  />
                  <button
                    type="button"
          ...
          <p className="text-center text-xs text-gray-400 mt-5">
            Agrotical v1.0 · Ελληνική Αγροτική Πλατφόρμα
          </p>
        </div>
      </div>
    </div>
